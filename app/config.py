...
class Settings(BaseSettings):
    ...
    llm_synthesis_model: str = "gemini/gemini-2.5-flash"   # litellm model string (writes the answer)
    llm_extraction_model: str = "gemini/gemini-2.5-flash"  # cheaper/extraction (same for now)
